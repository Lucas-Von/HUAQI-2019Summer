...
public class IncomeServiceImpl implements IncomeService, IncomeServiceForBl {
    ...
    public double getTotalStocksIncome(Long userId) {
        try {
            TotalIncomePO totalIncomePO = incomeMapper.getTotalInvestRate(userId);
            return totalIncomePO.getTotalStocks() - orderService.getInvestBy(userId, "DOMSTOCK", null);
        } catch (Exception e) {
            // e.printStackTrace();
            return 0;
        }
    ...
    public double getTotalQdiiIncome(Long userId) {
        try {
            TotalIncomePO totalIncomePO = incomeMapper.getTotalInvestRate(userId);
            return totalIncomePO.getTotalQdii() - orderService.getInvestBy(userId, "FORSTOCK", null);
        } catch (Exception e) {
            // e.printStackTrace();
            return 0;
        }
