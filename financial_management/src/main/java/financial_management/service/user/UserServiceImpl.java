    ...
    public BasicResponse register(UserParam userParam){
        try {
            ...
            if (wrongStatus == 0) {
                ...
                sb.append("<a href=\"http://localhost:8080/#/activeAccount/");
                sb.append(email);
                sb.append("\">http://localhost:8080/#/activeAccount/");
                sb.append(email);
                sb.append("</a>");
    ...
    public BasicResponse applyForUpdatePassword(String email){
        try {
            if (userMapper.ifExistEmail(email)) {
                ...
                sb.append("<a href=\"http://localhost:8080/#/changePassword/");
                sb.append(email);
                sb.append("\">http://localhost:8080/#/changePassword/");
                sb.append(email);
                sb.append("</a>");
