...
public final class ResponseStatus {
    ...
    public static final ResponseStatus STATUS_QUESTIONNAIRE_MLEARNING_WRONG = new ResponseStatus("6009","分析问卷时机器学习python函数出错");
    public static final ResponseStatus STATUS_QUESTIONNAIRE_VULNERABILITY_WRONG = new ResponseStatus("6010","分析问卷时脆弱性python函数出错");
    public static final ResponseStatus STATUS_QUESTIONNAIRE_ASSET_WRONG = new ResponseStatus("6011","分析问卷时资产python函数出错");
